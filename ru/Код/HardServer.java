...
public class ChatServer {
    ...
    //очередь, где хранятся все SocketProcessorы для рассылки
     ...
     * @throws IOException Если не удастся создать сервер-сокет, вылетит по эксепшену, объект Сервера не будет создан
     */
